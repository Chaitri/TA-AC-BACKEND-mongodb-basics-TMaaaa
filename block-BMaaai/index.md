...
```
mongoimport --db=test --collection=users --file=C:\Users\chait\Downloads\generated.json --jsonArray
```
...
```
mongoexport --db=test --collection=users --out=C:\Users\chait\Desktop\exported.json --jsonArray
```
...
```
mongoimport -d test -c students --type csv --file C:\Users\chait\Downloads\convertcsv.csv
--headerline
```
